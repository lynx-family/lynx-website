...
延续稳定的双月发布节奏，Lynx 3.5 带来了多项重要更新：主线程脚本支持了 `stopPropagation` 事件控制和首帧响应优化；新版本还进一步对齐了 HarmonyOS 平台能力，并新增了 `<pointer-events>` CSS 属性等功能。
