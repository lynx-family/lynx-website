---
title: 'Lynx 3.4: HarmonyOS 支持，Trace 和 Recorder，文本输入元件'
date: 2025-09-03
sidebar: false
authors: ['liujilong', 'lynx']
description: 'Lynx 3.4 已经正式发布! 新版本新增对 HarmonyOS 的适配支持、支持 Windows 作为 Lynx 开发环境、推出 *Trace* 与 *Recorder* 开发者工具、开源备受期待的原生组件 `<input>` 和 `<textarea>`，还带来了更灵活的动画效果、可变字体等功能。'
---
...
Lynx 现已正式支持 [HarmonyOS](https://www.harmonyos.com/) 平台。开发者可参考 [接入现有应用](/guide/start/quick-start.html?approach=building-block&integrate-platform=harmony)，将 Lynx 集成进 HarmonyOS 应用中。我们也将很快发布技术博客，深入介绍 Lynx 在 HarmonyOS 上的实现与优化，敬请期待。
...
参照官网[接入 Lynx 到现有应用](/zh/guide/start/quick-start.html?approach=building-block)，更新 Lynx 以及 LynxService 依赖版本，完成 Lynx 3.4 版本升级。
