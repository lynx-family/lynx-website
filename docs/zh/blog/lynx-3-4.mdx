...
- 构建工具 [Rspeedy](/guide/build/lynx-bundle) 现已支持 Windows 平台，开发者可在 Windows PC 上完成 Lynx 项目的开发与构建；
...
### 单行文本输入元件 [`<input>`](/api/elements/built-in/input) {#单行文本输入元件-input}
...
### 多行文本输入元件 [`<textarea>`](/api/elements/built-in/textarea) {#多行文本输入元件-textarea}
