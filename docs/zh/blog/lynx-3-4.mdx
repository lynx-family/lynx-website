...
延续今年初公布的[技术路线图](/blog/lynx-open-source-roadmap-2025)，我们在新版本中开源了若干 Lynx 技术栈的核心能力：开源了对 HarmonyOS 的适配支持；支持 Windows 作为 Lynx 开发环境；并引入了性能分析工具 Trace 与界面录制工具 Recorder，还新增了两个文本输入元件。
