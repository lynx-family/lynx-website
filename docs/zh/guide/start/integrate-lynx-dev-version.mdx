...
```ruby title="Podfile"
pod 'Lynx', '3.5.2' # [!code --]
pod 'Lynx', '3.5.2-dev' # [!code ++]

pod 'LynxDevtool', '3.5.2' # [!code --]
pod 'LynxDevtool', '3.5.2-dev' # [!code ++]
```
...
+ implementation ("org.lynxsdk.lynx:lynx:3.5.2-dev") {
+   // 排除 lynx-trace 模块，防止版本冲突
+  exclude group: 'org.lynxsdk.lynx', module: 'lynx-trace'
+ }

- implementation ("org.lynxsdk.lynx:lynx-trace:3.5.2")
+ implementation ("org.lynxsdk.lynx:lynx-trace:3.5.2-dev")

- implementation ("org.lynxsdk.lynx:lynx-devtool:3.5.2")
+ implementation ("org.lynxsdk.lynx:lynx-devtool:3.5.2") {
...
```json5
"dependencies": {
  "@lynx/lynx": "3.5.2", // [!code --]
  "@lynx/lynx_devtool": "3.5.2", // [!code --]
  "@lynx/lynx": "3.5.2-dev", // [!code ++]
  "@lynx/lynx_devtool": "3.5.2-dev", // [!code ++]
}
```
