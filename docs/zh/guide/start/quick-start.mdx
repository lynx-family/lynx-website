...
创建时会让你选择构建工具：搭配 [`pluginReactLynx`](/api/build/react-rsbuild-plugin.pluginreactlynx) 的 [Rsbuild](https://rsbuild.rs/)（推荐）、[Rspeedy](/guide/build/lynx-bundle)，或用于组件库的 [Rslib](https://rslib.rs/)。跟随提示来创建一个 Lynx 项目。
