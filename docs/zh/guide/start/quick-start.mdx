...
要在真实的 iOS 设备上运行 Lynx Explorer，请从 [App Store 下载 Lynx Go](https://apps.apple.com/us/app/lynx-go-dev-explorer/id6743227790)。

要在<ins>模拟器</ins>上运行 Lynx Explorer，请按照以下步骤操作：

1. **安装 Xcode**

打开 Mac App Store，搜索 [Xcode](https://apps.apple.com/us/app/xcode/id497799835)，点击安装（如果已安装则点击更新）。

2. **<div id="download-lynx-explorer,ios-platform=macos-arm64,explorer-platform=ios">下载 LynxExplorer</div>**

<PlatformTabs hashKey="ios-platform">
