...
2. 标/高清切换开关，调整当前调试投屏清晰度。
3. 切换当前投屏模式, 有 LynxView 和 FullScreen 两种模式。
...
4. 分割 **Elements** 面板和预览窗口的边框，拖动此边框可调整预览窗口大小。
5. 展示当前卡片使用的 JS 引擎。
...
<img
  src="https://lf-lynx.tiktok-cdns.com/obj/lynx-artifacts-oss-sg/lynx-website/assets/elements/elements-key1.png"
  class="full_image"
/>
...
<APITable query="devtool/panels.elements.view-and-edit" />

### 预览

<APITable query="devtool/panels.elements.preview" />
