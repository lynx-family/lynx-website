...
要在移动设备上实现本地持久存储功能，需要借助 Android 、iOS 和 HarmonyOS 的原生 API：
...
恭喜你，成功在 Lynx Explorer 中创建了原生模块！如果你想在你的应用中创建原生模块，首先需要参考[接入现有应用](/guide/start/quick-start?approach=building-block)指南集成 Lynx，然后参照上述步骤创建原生模块。
