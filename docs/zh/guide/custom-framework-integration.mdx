...
Lynx 可能会在稍晚一些时候开源其他框架（你可[在此处](https://github.com/lynx-family/lynx/issues/144#issuecomment-2705466656)关注其后续的进展），但是可能不会包括所有你可能想要的框架。如果你想要接入一个 Lynx 尚未支持或无支持计划的框架，你可以自己动手。

## 我们将构建什么？

此文档将通过**构建一个 Lynx 下的极简框架**，来展示如何将其他框架接入到 Lynx 中。
...
- 了解 Lynx 的基本概念。建议你已经阅读了[快速入门](/guide/start/quick-start)。
