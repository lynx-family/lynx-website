...
使用嵌套语法，很多时候可以简化对 CSS 类的定义，使用 [Sass](https://rsbuild.rs/zh/guide/styling/css-usage#sass) 或者是通过其他 [PostCSS](https://rsbuild.rs/zh/guide/styling/css-usage#postcss) 插件如 [postcss-nesting](https://github.com/csstools/postcss-plugins/tree/main/plugins/postcss-nesting) 处理。
