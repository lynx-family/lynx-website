...
使用嵌套语法，很多时候可以简化对 CSS 类的定义，使用 [Sass](https://rsbuild.rs/zh/guide/styling/css-usage#css-预处理器) 或者是通过其他 [PostCSS](https://rsbuild.rs/zh/guide/styling/css-usage#postcss) 插件如 [postcss-nesting](https://github.com/csstools/postcss-plugins/tree/main/plugins/postcss-nesting) 处理。
...
- [使用 CSS 后代选择器切换主题](/guide/styling/custom-theming#使用-css-后代选择器切换主题)
- [使用 CSS 变量切换主题](/guide/styling/custom-theming#使用-css-变量切换主题)
- [配置 CSS 继承](/guide/styling/custom-theming#按需使用-css-继承)
