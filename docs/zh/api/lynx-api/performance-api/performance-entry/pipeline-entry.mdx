...
1. **被 [`__lynx_timing_flag`](/guide/performance/metrics/timing-flag) 标记的 Lynx Pipeline**，产生的性能数据为 `PipelineEntry`。
...
<Go
  ...
  defaultFile="src/PipelineEntry/index.tsx"
  defaultEntryFile="dist/PipelineEntry.lynx.bundle"
  img="https://lf-lynx.tiktok-cdns.com/obj/lynx-artifacts-oss-sg/plugin/static/exmaple-pipeline-entry-new.png"
  entry="src/PipelineEntry"
  highlight="{11-21,31}"
/>
