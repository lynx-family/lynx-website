---
api: lynx-api/performance-api/performance-entry/pipeline-entry
---
...
1. **被 [`__lynx_timing_flag`](/guide/performance/monitor-performance/timing-flag) 标记的 Lynx Pipeline**，产生的性能数据为 `PipelineEntry`。
...
<img src="https://lf-lynx.tiktok-cdns.com/obj/lynx-artifacts-oss-sg/plugin/static/pipeline-entry-3-7-compressed.png" />
...
<Go
  ...
  img="https://lf-lynx.tiktok-cdns.com/obj/lynx-artifacts-oss-sg/plugin/static/exmaple-pipeline-entry-new.png"
