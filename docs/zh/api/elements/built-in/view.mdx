...
Android 上使用时需要在对应节点设置 [`flatten`](#flatten) 为 `false`，在 SDK 版本大于等于 3.5 支持 `androidEnablePixelCopy` 用 [PixelCopy](https://developer.android.com/reference/android/view/PixelCopy)方式截图。
:::
