...
下列示例代码订阅了 `CDP` 消息，当收到 [`Page.enable`](https://chromedevtools.github.io/devtools-protocol/tot/Page/#method-enable) 消息时，会发送一条内容为 `Hello, Lynx DevTool!` 的 [`Log.entryAdded`](https://chromedevtools.github.io/devtools-protocol/tot/Log/#event-entryAdded) 消息，再取消订阅。
