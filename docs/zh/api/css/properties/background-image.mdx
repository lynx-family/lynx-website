---
api: css/properties/background-image
---

import { APISummary, APITable, AndroidOnly, Go } from '@lynx';
...
- `<gradient>`
  目前支持 `linear-gradient`，`radial-gradient` 和 `conic-gradient`（3.6 版本开始支持）。
