...
- 更多说明可参考 [`enableCSSInheritance`](/packages/react-rsbuild-plugin#enablecssinheritance) 和 [`customCSSInheritanceList`](/packages/react-rsbuild-plugin#customcssinheritancelist)。
