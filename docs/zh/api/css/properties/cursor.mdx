...
- 更多说明可参考 [`enableCSSInheritance`](/rspeedy/plugins/plugin-react#enablecssinheritance) 和 [`customCSSInheritanceList`](/rspeedy/plugins/plugin-react#customcssinheritancelist)。
