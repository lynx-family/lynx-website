...
- 更多说明可参考 [`enableCSSInheritance`](/api/packages/react-rsbuild-plugin#enablecssinheritance) 和 [`customCSSInheritanceList`](/api/packages/react-rsbuild-plugin#customcssinheritancelist)。
