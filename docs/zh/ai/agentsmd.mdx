...
通过 [Quick Start](/guide/start/quick-start#创建一个-lynx-项目) 创建的新 Lynx 项目已经包含 `AGENTS.md`。对于已有项目，可以复制模板并根据你的项目进行调整：

- [`AGENTS.md` in Lynx Template Project](https://github.com/lynx-family/lynx-stack/blob/main/packages/build/create-lynx/template-common/AGENTS.md)
