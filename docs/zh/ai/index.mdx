...
[Agent Skills](skills.mdx) 是可复用的规则集，为 coding agent 提供关于 Lynx 双线程架构、常见模式和调试技巧的领域知识。使用 `npx skills add lynx-community/skills` 安装社区集合。

在 [Lynx Agent Skills](skills.mdx) 中了解更多信息。
