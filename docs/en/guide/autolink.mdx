...
The `targets` manifest and automatic native artifact packaging require matching tooling that supports this prerelease integration. Track availability in [lynx-stack #3760](https://github.com/lynx-family/lynx-stack/pull/3760) and [lynxtron #234](https://github.com/lynx-family/lynxtron/pull/234). Use compatible versions of `@lynx-js/autolink-codegen`, `create-lynx-library`, `@lynx-js/lynxtron-dev-plugins`, and `@lynx-js/lynxtron-builder`; installing an older published package does not enable these features.
