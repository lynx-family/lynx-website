...
The `targets` manifest and automatic native artifact packaging are available in the published `0.0.22` releases of `@lynx-js/create-lynxtron`, `@lynx-js/lynxtron`, `@lynx-js/lynxtron-dev-plugins`, and `@lynx-js/lynxtron-builder`. Library creation has been verified with `create-lynx-library@0.6.1` and `@lynx-js/autolink-codegen@0.6.0`. Use these compatible versions together and retain the lockfile when reproducing this guide.
