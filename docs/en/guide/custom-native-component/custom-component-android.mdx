...
```java
compileOnly project('org.lynxsdk.lynx:lynx-processor:3.6.0')
annotationProcessor project('org.lynxsdk.lynx:lynx-processor:3.6.0')
```
...
//dependency
kapt('org.lynxsdk.lynx:lynx-processor:3.6.0')
