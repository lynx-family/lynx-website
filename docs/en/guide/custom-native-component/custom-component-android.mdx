...
### Integrate the LynxProcessor Module

Add the following configuration to the `build.gradle` file:

```java
kapt project('org.lynxsdk.lynx:lynx-processor:3.5.2')
compileOnly project('org.lynxsdk.lynx:lynx-processor:3.5.2')
annotationProcessor project('org.lynxsdk.lynx:lynx-processor:3.5.2')
```
...
The following code demonstrates how to use the [SelectorQuery](/api/lynx-api/selector-query) API to call the `focus` method and make the `<explorer-input>` element gain focus:
