...
1. Click **Customize And Control DevTools** <InlineIcon src="https://lf-lynx.tiktok-cdns.com/obj/lynx-artifacts-oss-sg/lynx-website/assets/sources/more-options.png" alt="More options" /> > **Search** to open the **Search** panel.
...
- Click **Match Case** <InlineIcon src="https://lf-lynx.tiktok-cdns.com/obj/lynx-artifacts-oss-sg/lynx-website/assets/sources/match-case.png" alt="Match Case" /> to make the query case-sensitive.
- Click **Use Regular Expression** <InlineIcon src="https://lf-lynx.tiktok-cdns.com/obj/lynx-artifacts-oss-sg/lynx-website/assets/sources/use-regular.png" alt="Use Regular Expression" /> to search using a RegEx.
- Click **Refresh** <InlineIcon src="https://lf-lynx.tiktok-cdns.com/obj/lynx-artifacts-oss-sg/lynx-website/assets/sources/refresh.png" alt="Refresh" /> to search again.
- Click **Clear** <InlineIcon src="https://lf-lynx.tiktok-cdns.com/obj/lynx-artifacts-oss-sg/lynx-website/assets/sources/clear.png" alt="Clear" /> to clear the input contents.
...
After [configuring SourceMap](/api/config/output/source-map), you can directly debug the original code you author in the Sources panel.
...
1. A `debug-metadata.json` file is generated in the intermediate output directory (`dist/.lynx/<entry>/`).
   <img
     class="margin"
     src="https://lf-lynx.tiktok-cdns.com/obj/lynx-artifacts-oss-sg/lynx-website/assets/doc/devtool/sources/debug-metadata.png"
     alt="Debug metadata"
     style={{ height: 200 }}
   />
2. In the `tasm.json` file of the same directory, the `sourceContent.config.debugMetadataUrl` field is a valid URL pointing to the `debug-metadata.json` file mentioned in step one. Refer to [rspeedy.dev.assetprefix](https://rsbuild.rs/config/dev/asset-prefix).
   <img
     class="margin"
     src="https://lf-lynx.tiktok-cdns.com/obj/lynx-artifacts-oss-sg/lynx-website/assets/doc/devtool/sources/debug-metadata-url.png"
     alt="Debug metadata url"
     style={{ width: 600 }}
   />
...
<APITable query="devtool/panels.sources.breakpoints" />

### JS Engine

<APITable query="devtool/panels.sources.JSEngine" />
