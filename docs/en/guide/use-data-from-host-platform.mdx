...
:::note Prerequisites
You need to complete the instructions in [Integrate with existing applications](/guide/start/quick-start.html?approach=building-block) to ensure that your application has integrated Lynx and have a basic understanding of Lynx's Native API.
:::
