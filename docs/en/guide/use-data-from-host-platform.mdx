...
[`useInitData()`]: /react/api/hooks#useinitdata
[`InitDataConsumer`]: /react/api/components#initdataconsumer
[`InitDataProvider`]: /react/api/components#initdataprovider
[`lynx.registerdataprocessors`]: /react/api/types#lynx
