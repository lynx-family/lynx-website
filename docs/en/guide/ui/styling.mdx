...
You can get this in [Sass](https://rsbuild.rs/guide/styling/css-usage#css-preprocessors), which is already supported in ReactLynx, or other [post css plugins](https://rsbuild.rs/guide/styling/css-usage#postcss), such as [postcss-nesting](https://github.com/csstools/postcss-plugins/tree/main/plugins/postcss-nesting).
...
Lynx supports [CSS custom properties](/api/css/properties/css-variable.mdx) (CSS variables) and opt-in CSS inheritance for dynamic styling and theming.
...
- [Switch themes using CSS descendant selectors](/guide/styling/custom-theming#using-css-descendant-selectors-to-switch-themes)
- [Switch themes using CSS custom properties](/guide/styling/custom-theming#using-css-variables-to-switch-themes)
- [Configure Lynx's opt-in CSS inheritance](/guide/styling/custom-theming#leveraging-css-inheritance-as-needed)
