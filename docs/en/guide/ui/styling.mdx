...
You can get this in [Sass](https://rsbuild.rs/guide/styling/css-usage#sass), which is already supported in ReactLynx, or other [post css plugins](https://rsbuild.rs/guide/styling/css-usage#postcss), such as [postcss-nesting](https://github.com/csstools/postcss-plugins/tree/main/plugins/postcss-nesting).
