...
This feature depends on the HTTP service provided by the integrated [Lynx Service](/guide/start/quick-start?approach=building-block).
...
You can refer to the MDN documentation [Response: body](https://developer.mozilla.org/en-US/docs/Web/API/Response/body)
to learn how to handle a streaming body.
