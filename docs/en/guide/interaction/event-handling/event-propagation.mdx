import { PlatformTabs, Go, NoWeb } from '@lynx';
...
When used with [Main Thread Script](../../../react/main-thread-script.mdx), event propagation can be prevented by calling the [`stopPropagation`](../../../api/lynx-api/event/event.mdx#stoppropagation) method of the event object.
