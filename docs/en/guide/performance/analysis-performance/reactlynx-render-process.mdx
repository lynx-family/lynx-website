...
[First-frame Rendering](/guide/spec.html#first-frame-rendering-or-ffr) includes stages such as downloading the [Bundle](/guide/spec.html#lynx-bundle-or-bundle), loading the bundle, and drawing.
...
[Nested text](/api/elements/built-in/text.html#nested-text) will be merged with their parent text node to create a single platform UI.
