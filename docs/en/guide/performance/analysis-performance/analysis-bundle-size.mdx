...
[Rsdoctor](/rspeedy/use-rsdoctor) is a build-analysis tool that visualizes the asset list, module dependency graph, duplicate modules, and more. Enable it when building:
