...
<img
  src="https://lf-lynx.tiktok-cdns.com/obj/lynx-artifacts-oss-sg/plugin/static/debugging-devtool-switch-en-harmony.png"
  alt="Lynx DevTool Switch Page"
  width={200}
/>
...
:::info
The switch **Lynx DevTool** is persisted to support debugging when restarting the device or application.
:::
...
<APITable query="devtool/integration.switch" />
