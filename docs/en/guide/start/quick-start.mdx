...
It asks which build tool to use: [Rsbuild](https://rsbuild.rs/) with `pluginLynx` (recommended), [Rspeedy](/build), or [Rslib](https://rslib.rs/) for a component library. After completing the prompts, `create-lynx` will create a folder with your project name.
