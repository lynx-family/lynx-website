...
It is recommended to start a new project using [`create-lynx`](https://www.npmjs.com/package/@lynx-js/create-lynx),
...
It asks which build tool to use: [Rsbuild](https://rsbuild.rs/) with `pluginLynx` (recommended), [Rspeedy](/guide/build/lynx-bundle), or [Rslib](https://rslib.rs/) for a component library. After completing the prompts, `create-lynx` will create a folder with your project name.
