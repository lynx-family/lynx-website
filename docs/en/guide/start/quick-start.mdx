...
It is recommended to start a new project using [`@lynx-js/create-lynx`](https://www.npmjs.com/package/@lynx-js/create-lynx),
...
It asks which build tool to use: [Rsbuild](https://rsbuild.rs/) with [`pluginReactLynx`](/api/packages/react-rsbuild-plugin/functions/pluginReactLynx) (recommended), [Rspeedy](/guide/build/lynx-bundle), or [Rslib](https://rslib.rs/) for a component library. After completing the prompts, `@lynx-js/create-lynx` will create a folder with your project name.
