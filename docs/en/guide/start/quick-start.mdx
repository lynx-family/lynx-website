...
To run Lynx Explorer on real iOS device, download the [Lynx Go from App Store](https://apps.apple.com/us/app/lynx-go-dev-explorer/id6743227790).

To run Lynx Explorer on <ins>Simulator</ins>, follow the steps below:
...
2. **<div id="download-lynx-explorer,ios-platform=macos-arm64,explorer-platform=ios">Download LynxExplorer</div>**
