...
It asks which build tool to use: [Rsbuild](https://rsbuild.rs/) with [`pluginReactLynx`](/api/build/react-rsbuild-plugin.pluginreactlynx) (recommended), [Rspeedy](/guide/build/lynx-bundle), or [Rslib](https://rslib.rs/) for a component library. After completing the prompts, `@lynx-js/create-lynx` will create a folder with your project name.
