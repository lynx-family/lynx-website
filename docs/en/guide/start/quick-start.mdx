...
You can download the pre-built app from the [GitHub Release](https://github.com/lynx-family/lynx/releases/latest).
...
You will see a QR code showing up in the terminal, scan with your Lynx Explorer App or if you are using the simulator or running the desktop explorer, just copy the bundle URL and paste it on the "Enter Card URL" input in the Lynx Explorer App and hit "Go".
