...
Use [Lynx Explorer](https://github.com/lynx-family/lynx), a pre-built sandbox app, to start developing and previewing Lynx pages instantly, no native toolchain required. Great for learning, prototyping, and development. For production deployment, [integrate with your existing app](/guide/start/integrate-with-existing-apps) or [build a new app on an app framework](/guide/start/build-with-app-framework).

### System Requirements

- [Node.js 20.19](https://nodejs.org/en) or later. Node.js 22.12 or later is also supported.
...
It is recommended to start a new project using [`create-rspeedy`](https://www.npmjs.com/package/create-rspeedy),
...
Download [`LynxExplorer-arm64.app.tar.gz`](https://github.com/lynx-family/lynx/releases/download/3.9.0/LynxExplorer-arm64.app.tar.gz).
...
Download [`LynxExplorer-x86_64.app.tar.gz`](https://github.com/lynx-family/lynx/releases/download/3.9.0/LynxExplorer-x86_64.app.tar.gz).
...
Scan the QR code to download the pre-built app from [GitHub Release 3.9.0](https://github.com/lynx-family/lynx/releases/tag/3.9.0).
...
Download the pre-built app [`lynx_explorer-default-unsigned.hap`](https://github.com/lynx-family/lynx/releases/download/3.9.0/lynx_explorer-default-unsigned.hap).
