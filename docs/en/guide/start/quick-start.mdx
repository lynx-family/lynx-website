...
Follow the step-by-step integration guide for your target platform:

<PlatformTabs queryKey="integrate-platform">
<PlatformTabs.Tab platform="ios">

See the detailed [iOS integration guide](/guide/start/integrate-with-existing-apps?platform=ios) for step-by-step instructions on adding Lynx to your iOS application.

</PlatformTabs.Tab>

<PlatformTabs.Tab platform="android">

See the detailed [Android integration guide](/guide/start/integrate-with-existing-apps?platform=android) for step-by-step instructions on adding Lynx to your Android application.

</PlatformTabs.Tab>

<PlatformTabs.Tab platform="harmony">

See the detailed [HarmonyOS integration guide](/guide/start/integrate-with-existing-apps?platform=harmony) for step-by-step instructions on adding Lynx to your HarmonyOS application.

</PlatformTabs.Tab>

<PlatformTabs.Tab platform="web">

See the detailed [Web integration guide](/guide/start/integrate-with-existing-apps?platform=web) for step-by-step instructions on adding Lynx to your web application.
