...
Or, you may built from source by following the [Build Lynx Explorer for Android](https://github.com/lynx-family/lynx/tree/develop/explorer/android) guide.
...
<NextSteps.Step
  ...
  title="Elements"
  description="Checkout the builtin elements that Lynx has"
/>
