---
description: 'Integrating the Lynx development version with Trace and Recorder for debugging.'
---
...
Refer to the [Lynx integration guide](/guide/start/quick-start.html?approach=building-block&integrate-platform=ios) for detailed steps on integrating Lynx.
...
Refer to the [Lynx integration guide](/guide/start/quick-start.html?approach=building-block&integrate-platform=android) for detailed steps on integrating Lynx.
...
Refer to the [Lynx integration guide](/guide/start/quick-start.html?approach=building-block&integrate-platform=harmony) for detailed steps on integrating Lynx.
