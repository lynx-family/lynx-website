### Integrate Lynx with Existing Apps (Web) \{#integrate-lynx-with-web-platform,platform=web}
...
## 1. Build web artifact \{#build-web-artifact,platform=web}

We need you to have read and created a Lynx project according to [Quick Start](/guide/start/quick-start).

<Steps>

### Add web configuration \{#add-web-configuration,platform=web}
...
## 2. Integrate with a new web project \{#integrate-web-project,platform=web}

Now that you have a Lynx for Web build artifact, we need to create a web project to use it. Here we use Rsbuild.

<Steps>

### Create a web project \{#create-web-project,platform=web}
...
### Configure the project \{#configure-project,platform=web}
...
### Start the project \{#start-project,platform=web}
...
## 3. API Reference \{#api-reference,platform=web}
...
### 3.1 lynx-view \{#lynx-view,platform=web}

#### 3.1.1 Attributes \{#lynx-view-attributes,platform=web}
...
#### 3.2 Properties \{#lynx-view-properties,platform=web}
...
#### 3.3 Events \{#lynx-view-events,platform=web}
...
#### 3.4 Methods \{#lynx-view-methods,platform=web}
...
#### 3.5 Width and Height \{#lynx-view-width-height,platform=web}
...
### 3.2 Compatibility \{#compatibility,platform=web}
...
### 3.3 FAQ \{#faq,platform=web}

#### 3.3.1 Runtime error: `Uncaught SecurityError: Failed to construct 'Worker': Script at 'xxx' cannot be accessed from origin 'xxx'.` \{#runtime-error,platform=web}
...
#### 3.3.2 Performance Optimization \{#performance-optimization,platform=web}
