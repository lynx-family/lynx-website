### Integrate Lynx with Existing Apps (Android) \{#integrate-lynx-with-existing-apps-android,platform=android}
...
## 1. Dependency configuration \{#dependency-configuration,platform=android}

<Steps>

### Configuring Gradle \{#configuring-gradle,platform=android}
...
### Configure obfuscation rules ([Proguard](https://developer.android.com/build/shrink-code)) \{#configure-obfuscation-rules,platform=android}
...
## 2. Environment Initialization \{#environment-initialization,platform=android}

<Steps>

### Lynx Service Initialization \{#lynx-service-initialization,platform=android}
...
### LynxEnv Initialization \{#lynx-env-initialization,platform=android}
...
## 3. Render LynxView \{#render-lynxview,platform=android}

<Steps>

### Create Bundle Loader \{#create-bundle-loader,platform=android}
...
### Construct LynxView \{#construct-lynxview,platform=android}
...
### Introduce XElement \{#introduce-xelement,platform=android}
...
### 4 Render view \{#render-view,platform=android}
...
## 4. Now what? \{#now-what,platform=android}
