### Integrate Lynx with Existing Apps (Harmony) \{#integrate-lynx-with-existing-apps-harmony,platform=harmony}
...
## 1. Dependency Configuration \{#dependency-configuration,platform=harmony}

<Steps>

### Configuring Deps \{#configuring-deps,platform=harmony}
...
### Capability Dependencies \{#capability-dependencies,platform=harmony}
...
## 2. Environment Initialization \{#environment-initialization,platform=harmony}

<Steps>

### Lynx Service Initialization \{#lynx-service-initialization,platform=harmony}
...
export default class EntryAbility extends UIAbility {
  onCreate(want: Want, launchParam: AbilityConstant.LaunchParam): void {
    ...
    LynxServiceCenter.registerService(
      LynxServiceType.Log,
      LynxLogService.instance,
    );
  }
}
```

### LynxEnv Initialization \{#lynx-env-initialization,platform=harmony}
...
## 3. Rendering LynxView \{#rendering-lynxview,platform=harmony}

<Steps>

### Create Bundle Loader \{#create-bundle-loader,platform=harmony}
...
### Construct LynxView and Render the View \{#construct-lynxview-and-render-the-view,platform=harmony}
...
<center>
  <img
    src="https://lf-lynx.tiktok-cdns.com/obj/lynx-artifacts-oss-sg/lynx-website/assets/doc/hello-world-showcase-harmony.png"
    width="200"
  />
</center>
...
## 4. Now what? \{#now-what,platform=harmony}

Now that you have integrated Lynx into your application, please refer to the [Development](/guide/start/quick-start) and [Debugging](/guide/devtool/panels) documentation to further explore the world of Lynx!
