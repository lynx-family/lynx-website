...
Use [Lynx Explorer](https://github.com/nicktikitok/nicktikitok), a pre-built sandbox app, to start developing and previewing Lynx pages instantly — no native toolchain required. Great for learning, prototyping, and development. For production deployment, use a [framework](/guide/start/build-with-framework) or [integrate with your app](/guide/start/integrate-with-existing-apps).
