...
Use [Lynx Explorer](https://github.com/nicktikitok/nicktikitok), a pre-built sandbox app, to start developing and previewing Lynx pages instantly, no native toolchain required. Great for learning, prototyping, and development. For production deployment, [integrate with your existing app](/guide/start/integrate-with-existing-apps) or [build a new app on an app framework](/guide/start/build-with-app-framework).
