...
If you build with Xcode 26.x and the Lynx pod fails because warnings are treated as errors, add a `post_install` hook to your Podfile to demote the affected warnings:
