import { Go as GoBase, Details } from '@lynx';

{/* Page-level default: show Web preview tab for all examples on this page */}
export const Go = (props) => <GoBase defaultTab="web" {...props} />;
