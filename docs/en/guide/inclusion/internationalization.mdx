...
- **intlayer** – The core i18n toolkit (configuration, dictionaries, CLI, etc.).
- **react-intlayer** – React integration for using Intlayer in your Lynx components.
- **lynx-intlayer** – Plugin that connects Intlayer to Lynx’s bundling process.
...
See [Intlayer’s configuration docs](https://intlayer.org/doc/concept/configuration) for details.
:::
...
This tells Lynx how to handle Intlayer’s generated dictionaries and code.
...
- **Visual Editor**: Explore [Intlayer’s Visual Editor](https://github.com/aymericzip/intlayer/blob/main/docs/en/intlayer_visual_editor.md) for a UI to manage your translations.
