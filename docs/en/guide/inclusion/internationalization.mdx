---
description: 'Implementing internationalization (i18n) in Lynx apps using i18next.'
---
...
:::tip
You may need [build-time type declarations](/guide/build/typescript.md#build-time-type-declarations) for `import.meta.webpackContext`.
:::
