...
Lynx provides compatibility tables for each API, built-in component, and CSS property. Use the interactive explorer below to search and discover compatibility information:
...
The explorer helps you quickly find version compatibility details, supported platforms, and feature availability for any Lynx API without navigating through multiple documentation pages.
