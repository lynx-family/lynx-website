...
- This capability is currently integrated for Android in Lynx 3.8
...
For implementation background, see the [PrimJS WebAssembly document](https://github.com/lynx-family/primjs/blob/develop/docs/wasm.md).
