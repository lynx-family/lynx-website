...
This support is intended for common module loading and execution scenarios. At the moment, Lynx does not expose the complete WebAssembly JavaScript API surface. See [WebAssembly](/guide/scripting-runtime/webassembly.html) for the supported scope and current limitations.
