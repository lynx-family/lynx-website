...
This support is intended for common module loading and execution scenarios, and is currently available on the background thread only. At the moment, Lynx does not expose the complete WebAssembly JavaScript API surface. See [WebAssembly](/guide/scripting-runtime/webassembly.html) for the supported scope and current limitations.
...
- [Array.prototype[@@iterator]](https://tc39.es/ecma262/#sec-array.prototype-@@iterator)
...
- [Array.prototype[@@unscopables].flat](https://tc39.es/ecma262/#sec-array.prototype-@@unscopables)
- [Array.prototype[@@unscopables].flatMap](https://tc39.es/ecma262/#sec-array.prototype-@@unscopables)
...
- [Number.parseFloat](https://tc39.es/ecma262/#sec-number.parseFloat)
...
- [RegExp](https://tc39.es/ecma262/#sec-regexp-constructor)
...
- Path with [alias](/rspeedy/config/source#source-alias): `@common/foo.js`
