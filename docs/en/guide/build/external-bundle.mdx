...
Compared with [Chunk Splitting](https://rsbuild.rs/config/performance/chunk-split), External Bundle is for cross-application reuse, while Chunk Splitting is for splitting code inside one app.

This workflow has two parts:

1. Use [`@lynx-js/lynx-bundle-rslib-config`](/api/packages/lynx-bundle-rslib-config) to build the external bundle.
2. Use [`@lynx-js/external-bundle-rsbuild-plugin`](/api/packages/external-bundle-rsbuild-plugin) to load it in the host app.
...
- [`defineExternalBundleRslibConfig()`](/api/packages/lynx-bundle-rslib-config#defineexternalbundlerslibconfig)
- [`pluginExternalBundle()`](/api/packages/external-bundle-rsbuild-plugin#pluginexternalbundle)
- [`@lynx-js/lynx-bundle-rslib-config`](/api/packages/lynx-bundle-rslib-config)
- [`@lynx-js/external-bundle-rsbuild-plugin`](/api/packages/external-bundle-rsbuild-plugin)
