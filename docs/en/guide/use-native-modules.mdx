...
Congratulations! You have successfully created a native module in Lynx Explorer! If you want to create a native module in your application, you first need to integrate Lynx by referring to the [Integrate with Existing Apps](/guide/start/quick-start?approach=building-block) guide, and then follow the steps above to create the native module.
