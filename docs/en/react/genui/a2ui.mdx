...
You can start with the [Mock Example](#mock-example), then explore the [Playground](#try-the-playground), and finally read the [Integration Guide](#learn-the-details); if you want to better understand the principles behind the Agent + Catalog collaboration model, continue with [Core Concepts and Use Cases](#core-concepts-and-use-cases).
