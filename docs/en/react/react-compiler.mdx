...
Because the compiler introduces additional runtime logic, it may slightly affect [IFR](../guide/interaction/ifr.mdx) performance or initial background-thread rendering. We recommend enabling React Compiler in cases where initial IFR performance is less critical, or where re-render efficiency and developer experience are the higher priorities.
