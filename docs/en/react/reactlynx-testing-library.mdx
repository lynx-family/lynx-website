...
A project created with [`create-lynx`](https://www.npmjs.com/package/@lynx-js/create-lynx) comes with Rstest and ReactLynx Testing Library already set up. Run the tests with `npm run test`.
