...
For a full list of APIs ReactLynx implemented, please refer to the [`@lynx-js/react` API documentation](/api/react/).
...
**Extra Topics**: Consult the [API Reference](/api/react/) and use [Framework Performance Profiling](/guide/performance/analysis-performance/analysis-framework) to investigate performance issues.
