...
- **[Compiler-Informed Rendering](./snapshot.mdx)**: ReactLynx extracts static JSX structures into a reusable compiled representation so the runtime can focus on dynamic values and subtrees.
