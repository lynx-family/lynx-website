...
:::info
Please note that `@tanstack/react-router` and `@tanstack/router-plugin` higher than `1.121.34` introduced some changes that cause blank screen issues.
The Lynx team is currently working on compatibility solutions.
:::

Install dependencies:

<PackageManagerTabs command="install @tanstack/react-router@1.121.34 url-search-params-polyfill" />

Install devDependencies:

<PackageManagerTabs command="install @tanstack/router-plugin@1.121.34 -D" />
