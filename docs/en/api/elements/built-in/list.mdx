...
```tsx
// DefaultValue: true (false on Clay)
'scroll-bar-enable'?: boolean
```

Indicates whether the `<list>` component scroll bar is displayed. On Clay, this is a deprecated alias for [`enable-scrollbar`](#enable-scrollbar) and defaults to `false`.
