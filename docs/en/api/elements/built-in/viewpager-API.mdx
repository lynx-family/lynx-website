...
<APIBadge data={viewpagerData.elements.viewpager} query="attributes/android-always-overscroll" />
...
<APIBadge data={viewpagerData.elements.viewpager} query="attributes/android-force-can-scroll" />
...
<APIBadge data={viewpagerData.elements.viewpager} query="attributes/bounces" />
...
<APIBadge data={viewpagerData.elements.viewpager} query="attributes/enable-scroll" />
...
<APIBadge data={viewpagerData.elements.viewpager} query="attributes/initial-select-index" />
...
<APIBadge data={viewpagerData.elements.viewpager} query="attributes/ios-gesture-direction" />
...
<APIBadge data={viewpagerData.elements.viewpager} query="attributes/ios-gesture-offset" />
...
<APIBadge data={viewpagerData.elements.viewpager} query="attributes/ios-recognized-gesture-class" />
...
<APIBadge data={viewpagerData.elements.viewpager} query="attributes/ios-recognized-view-tag" />
...
<APIBadge data={viewpagerData.elements.viewpager} query="attributes/keep-item-view" />
...
<APIBadge data={viewpagerData.elements.viewpager} query="events/bindchange" />
...
<APIBadge data={viewpagerData.elements.viewpager} query="events/bindoffsetchange" />
...
<APIBadge data={viewpagerData.elements.viewpager} query="events/bindwillchange" />
...
<APIBadge data={viewpagerData.elements.viewpager} query="methods/selectTab" />
