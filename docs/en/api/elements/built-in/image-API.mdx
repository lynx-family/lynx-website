import { AndroidOnly, IOSOnly, ClayOnly, HarmonyOnly, Required, Deprecated, Go, PlatformTabs } from '@lynx';
...
### `auto-size`
 ...
 <AndroidOnly /> <IOSOnly /> <ClayOnly /> <HarmonyOnly /> <AvailableBadge type="version" data={{ version: '2.6', support: 'support' }} />
...
### `autoplay`
 ...
 <AndroidOnly /> <IOSOnly /> <ClayOnly /> <HarmonyOnly /> <AvailableBadge type="version" data={{ version: '2.11', support: 'support' }} />
...
### `blur-radius`
 ...
 <AndroidOnly /> <IOSOnly /> <ClayOnly /> <HarmonyOnly /> <AvailableBadge type="version" data={{ version: '0.2', support: 'support' }} />
...
### `cap-insets`
 ...
 <AndroidOnly /> <IOSOnly /> <ClayOnly /> <HarmonyOnly /> <AvailableBadge type="version" data={{ version: '1.4', support: 'support' }} />
...
### `defer-src-invalidation`
 ...
 <AndroidOnly /> <IOSOnly /> <ClayOnly /> <HarmonyOnly /> <AvailableBadge type="version" data={{ version: '2.7', support: 'support' }} />
...
### `image-config`
 ...
 <AndroidOnly /> <ClayOnly /> <AvailableBadge type="version" data={{ version: '1.4', support: 'support' }} />
...
### `prefetch-height`
 ...
 <AndroidOnly /> <IOSOnly /> <AvailableBadge type="version" data={{ version: '1.4', support: 'support' }} />
...
### `tint-color`
 ...
 <AndroidOnly /> <IOSOnly /> <HarmonyOnly /> <AvailableBadge type="version" data={{ version: '2.12', support: 'support' }} />
