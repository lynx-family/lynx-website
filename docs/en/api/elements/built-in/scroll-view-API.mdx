...
Enables the scrollbar when the content overflows. This is the preferred attribute name on Clay. Web Lynx also accepts this name for `<scroll-view>`.
...
Enables the scrollbar when the content overflows. Android supports vertical scrollbars only. On Clay, this name is a deprecated alias; use [`enable-scrollbar`](#enable-scrollbar) instead. Web Lynx accepts both names for `<scroll-view>`.
