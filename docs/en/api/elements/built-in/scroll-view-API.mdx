...
### `bounces`
 ...
 <IOSOnly /> <ClayOnly /> <HarmonyOnly /> <AvailableBadge type="version" data={{ version: '1.4', support: 'support' }} />
...
### `initial-scroll-offset`
 ...
 <AndroidOnly /> <IOSOnly /> <ClayOnly /> <HarmonyOnly /> <AvailableBadge type="version" data={{ version: '2.17', support: 'support' }} />
...
### `scroll-orientation`
 ...
 <AndroidOnly /> <IOSOnly /> <ClayOnly /> <HarmonyOnly /> <AvailableBadge type="version" data={{ version: '3.0', support: 'support' }} />
...
### `bindcontentsizechanged`
 <AndroidOnly /> <IOSOnly /> <HarmonyOnly /> <AvailableBadge type="version" data={{ version: '1.6', support: 'support' }} />
...
### `bindscrollend`
 <AndroidOnly /> <IOSOnly /> <ClayOnly /> <HarmonyOnly /> <AvailableBadge type="version" data={{ version: '1.6', support: 'support' }} />
...
### `bindscrolltolower`
 <AndroidOnly /> <IOSOnly /> <HarmonyOnly /> <AvailableBadge type="version" data={{ version: '1.4', support: 'support' }} />
