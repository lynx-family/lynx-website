...
- See [`enableCSSInheritance`](/plugins/plugin-react#enablecssinheritance) and [`customCSSInheritanceList`](/plugins/plugin-react#customcssinheritancelist) for more details.
