...
- See [`enableCSSInheritance`](/packages/react-rsbuild-plugin#enablecssinheritance) and [`customCSSInheritanceList`](/packages/react-rsbuild-plugin#customcssinheritancelist) for more details.
