...
- See [`enableCSSInheritance`](/rspeedy/plugins/plugin-react#enablecssinheritance) and [`customCSSInheritanceList`](/rspeedy/plugins/plugin-react#customcssinheritancelist) for more details.
