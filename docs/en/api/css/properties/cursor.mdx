...
- See [`enableCSSInheritance`](/api/packages/react-rsbuild-plugin#enablecssinheritance) and [`customCSSInheritanceList`](/api/packages/react-rsbuild-plugin#customcssinheritancelist) for more details.
