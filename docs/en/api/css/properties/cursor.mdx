...
<Go
  ...
  img="https://lf-lynx.tiktok-cdns.com/obj/lynx-artifacts-oss-sg/lynx-website/assets/doc/css/cursor.png"
...
- See [`enableCSSInheritance`](/api/build/react-rsbuild-plugin.pluginreactlynxoptions.enablecssinheritance) and [`customCSSInheritanceList`](/api/build/react-rsbuild-plugin.pluginreactlynxoptions.customcssinheritancelist) for more details.
