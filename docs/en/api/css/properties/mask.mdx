...
|                              |                                                                                                                                                                                                                                                                                                                                              |
| ---------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Initial values**           | as each of the properties of the shorthand: <br/> <ul style={{ listStyleType: "disc", paddingLeft: "1.5rem" }}> <li> [mask-image](./mask-image): none</li> <li>mask-repeat: repeat</li><li>mask-position: center</li><li>mask-clip: border-box</li><li>mask-composite: add</li><li>mask-origin: border-box</li><li>mask-size: auto</li></ul> |
...
2. `mask-composite` is only supported on PC platforms since Lynx 4.0.
3. `mask-image` does not support SVG references.
4. only support border-box, padding-box and content-box.
