import { Go, Tip } from '@lynx';

# Custom properties (`--*`): CSS variables

## Introduction

<Tip title="Experimental： CSS variables in inline styles">
  You can declare CSS variables and reference them in inline styles after
  release 3.5.
...
<view
  ...
  style={{
    ...
    color: 'white',
    backgroundColor: 'var(--main-bg-color)', // [!code highlight]
    width: '100%',
    height: 'var(--main-height)', // [!code highlight]
  }}
/>
```
