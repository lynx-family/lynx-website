...
:::tip
It is recommended to call this method during initialization, such as in the constructor of a root component or within the [`useMemo`](/react/api/hooks#built-in-react-hooks) Hook,
