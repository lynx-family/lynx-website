...
:::warning
This event has been deprecated since Lynx SDK 3.7. Related data can be obtained from [`PipelineEntry`](/api/lynx-api/performance-api/performance-entry/pipeline-entry).
:::
...
You can generate this metric by marking the [lynx pipeline](/guide/spec#lynx-pipeline) that contains important elements with [`__lynx_timing_flag="__lynx_timing_actual_fmp"`](/guide/performance/monitor-performance/timing-flag).
