import { Go, RuntimeBadge } from '@lynx';
...
Calling it in the [main thread script](../../../react/main-thread-script.mdx) can affect both event bubbling and event handler triggering in `JS`.
