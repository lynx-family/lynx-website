...
```c
void lynx_view_load_template(lynx_view_t* view, lynx_load_meta_t* data);
```

#### Parameters

- `view`: The `lynx_view_t` instance to render.
- `data`: The load metadata created with `lynx_load_meta_create()`.
