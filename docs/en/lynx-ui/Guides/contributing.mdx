...
Each component lives in `packages/<component-name>` and usually contains:
...
Then run the matching example package:
...
- Pull requests are squash-merged. The final merged PR must become a single commit.
