...
LLMs are trained on public web data, which means they're often lack awareness of the latest Lynx features and best practices. The Lynx team and community are developing a suite of tools to help LLMs understand and develop Lynx more effectively.

## Teaching LLMs about Lynx

### Using Lynx Docs MCP

[Model Context Protocol](https://modelcontextprotocol.io/docs/getting-started/intro) is a standard for connecting LLMs to external tools. Lynx Docs MCP lets the agent fetch accurate guides, API references directly from the Lynx documentation site, to ensure its answers stay correct and up to date.
...
It lets coding agents to _**control, operate and preview**_ Lynx pages, just like human does in DevTool.
