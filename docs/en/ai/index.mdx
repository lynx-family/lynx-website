...
[Agent Skills](skills.mdx) are reusable rule sets that give coding agents domain-specific knowledge about Lynx's dual-thread architecture, common patterns, and debugging techniques. Install the community collection with `npx skills add lynx-community/skills`.

Read more in [Agent Skills for Lynx](skills.mdx).
