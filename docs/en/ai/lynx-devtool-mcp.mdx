...
Lynx DevTool MCP is a [Model Context Protocol (MCP) server](https://modelcontextprotocol.io/docs/learn/server-concepts) that lets coding agents to _**control, operate and preview**_ Lynx pages.
...
Using Lynx DevTool MCP server just like using DevTool.
