---
description: 'Standards and best practices for writing documentation guides.'
---
...
For excellent examples of well-structured guides, refer to the [Quick Start](/guide/start/quick-start) and [Integrate with Existing Apps](/guide/start/quick-start?approach=building-block) pages.
...
See [MDX Components Reference](./components#platform-badges) for usage details.

## Related Resources

- [**MDX Components Reference**](./components) - A catalog of custom components available for use in guides.
- [**Managing Examples**](./example) - Instructions for embedding interactive code examples.
- [**API Reference**](./api) - For details on documenting technical API specifications.
