...
- From background to main thread: Use [`runOnMainThread`](/api/react/Function.runOnMainThread)
- From main thread to background: Use [`runOnBackground`](/api/react/Function.runOnBackground)
