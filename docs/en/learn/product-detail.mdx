...
- From background to main thread: Use [`runOnMainThread`](/react/api/functions#runonmainthread)
- From main thread to background: Use [`runOnBackground`](/react/api/functions#runonbackground)
