...
The Lynx toolchain is built on top of [Rspack](https://rspack.rs/), and we already collaborate closely with the Rspack community to deliver high-performance [Rspeedy](/guide/build/lynx-bundle) toolchains. This partnership with the web tooling ecosystem provides a strong foundation for broader engagement.
