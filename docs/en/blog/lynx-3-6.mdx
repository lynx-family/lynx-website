...
To upgrade to Lynx 3.6, follow the [integration guide](https://lynxjs.org/3.6/guide/start/quick-start.html?approach=building-block) and update your Lynx dependency versions accordingly.
