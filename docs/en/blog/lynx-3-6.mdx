...
In practice, nested variables are used to map global theme decisions to component-level styling tokens.
Global theme variables establish visual foundations such as color, typography, spacing, and elevation. while local component variables reference and refine those values into concrete styles.
