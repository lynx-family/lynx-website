...
Lynx 3.6 is now officially released! This release introduces `reactlynx-use` for improved developer ergonomics, launch an LLM toolset to enhance AI-native development capabilities, and enhances CSS capabilities for design expressiveness.
