...
CSS serves as **a medium for expressing design intent**, including how values are scoped, composed, and perceived across the component tree.
...
CSS variables in Lynx 3.6 can also be defined in terms of other variables. This allows theme definitions to be layered compositionally.

In practice, nested variables are used to encode how design intent flows into concrete usage: global theme variables establish the visual foundations, while local component variables resolve that intent into specific styles.
By expressing these references directly in CSS, the theme's structure becomes part of the code itself rather than something inferred from design documentation or conventions.
