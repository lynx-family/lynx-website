...
In the future, we will gradually introduce more feature support as our [roadmap](g/blog/lynx-open-source-roadmap-2025.html). We'll add new components like `<Input>` and adapt to more platforms such as HarmonyOS and PC.
