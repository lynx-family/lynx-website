...
Please refer to the [integrate-with-existing-apps](/guide/start/quick-start.html?approach=building-block&integrate-platform=ios) and update your Lynx and LynxService dependencies.
