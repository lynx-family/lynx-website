...
- The build tool [Rspeedy](/guide/build/lynx-bundle) now supports the Windows, enabling developers to develop and build Lynx projects on Windows PCs;
...
### Single-line [`<input>`](/api/elements/built-in/input) Element {#single-line-input-element}
...
### Multi-line [`<textarea>`](/api/elements/built-in/textarea) element {#multi-line-textarea-element}
