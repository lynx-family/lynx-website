...
- To advance our vision of democratizing cross-platform technologies, we aim to collaborate with the community to further enhance the [Element PAPI](/guide/spec.html#element-papi), making it more framework-agnostic and better suited to support more frameworks on Lynx engine.
