...
<div
  style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', columnGap: '20px' }}
>
...
In this demo, we emulate a scenario where we have to decode HEIC images in
JavaScript. Decoding is a CPU-intensive task. Even if we move the decoding into
useEffect, the main thread is still blocked. This causes CSS animations to lag.
In Lynx, effects don't wait for rendering to finish and don't block rendering.
This design prioritizes high-priority rendering tasks and keeps effects
executing quickly.
