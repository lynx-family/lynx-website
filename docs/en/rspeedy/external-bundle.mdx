...
Compared with [Chunk Splitting](/config/#performance-chunksplit), External Bundle is for cross-application reuse, while Chunk Splitting is for splitting code inside one app.

This workflow has two parts:

1. Use [`@lynx-js/lynx-bundle-rslib-config`](/packages/lynx-bundle-rslib-config) to build the external bundle.
2. Use [`@lynx-js/external-bundle-rsbuild-plugin`](/packages/external-bundle-rsbuild-plugin) to load it in the host app.
...
- [`defineExternalBundleRslibConfig()`](/packages/lynx-bundle-rslib-config#defineexternalbundlerslibconfig)
- [`pluginExternalBundle()`](/packages/external-bundle-rsbuild-plugin#pluginexternalbundle)
- [`@lynx-js/lynx-bundle-rslib-config`](/packages/lynx-bundle-rslib-config)
- [`@lynx-js/external-bundle-rsbuild-plugin`](/packages/external-bundle-rsbuild-plugin)
