...
Compared with [Chunk Splitting](/api/config/#performance-chunksplit), External Bundle is for cross-application reuse, while Chunk Splitting is for splitting code inside one app.
