...
Compared with [Chunk Splitting](/rspeedy/config/performance#performance-chunksplit), External Bundle is for cross-application reuse, while Chunk Splitting is for splitting code inside one app.

This workflow has two parts:

1. Use [`@lynx-js/lynx-bundle-rslib-config`](/rspeedy/plugins/lynx-bundle-rslib-config) to build the external bundle.
2. Use [`@lynx-js/external-bundle-rsbuild-plugin`](/rspeedy/plugins/plugin-external-bundle) to load it in the host app.
...
- [`defineExternalBundleRslibConfig()`](/rspeedy/plugins/lynx-bundle-rslib-config#defineexternalbundlerslibconfig)
- [`pluginExternalBundle()`](/rspeedy/plugins/plugin-external-bundle#pluginexternalbundle)
- [`@lynx-js/lynx-bundle-rslib-config`](/rspeedy/plugins/lynx-bundle-rslib-config)
- [`@lynx-js/external-bundle-rsbuild-plugin`](/rspeedy/plugins/plugin-external-bundle)
