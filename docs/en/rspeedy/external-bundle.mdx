...
### Bundle Plain TypeScript

Plain TypeScript doesn't need `pluginReactLynx`. `pluginLynx` is the Lynx build engine, and `LAYERS` picks the thread the bundle runs on:
