...
2. Configuring PostCSS
   ...
   You can register the tailwindcss PostCSS plugin through [`postcss.config.cjs`](https://www.npmjs.com/package/postcss-loader#config) or [`tools.postcss`](https://rsbuild.rs/config/tools/postcss).
