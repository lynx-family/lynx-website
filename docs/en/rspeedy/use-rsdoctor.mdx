---
description: 'Analyze and diagnose builds with Rsdoctor in Rspeedy projects.'
---
...
If you need to configure the [options](https://rsdoctor.dev/config/options/options#options) provided by the Rsdoctor plugin, use [`tools.rsdoctor`](/config/tools#tools-rsdoctor).
