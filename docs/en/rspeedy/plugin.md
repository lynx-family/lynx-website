...
Before finding plugin, you may want to check if the feature you want is already included in [Rspeedy Configuration](/api/config/).
...
[`tools.rspack.plugins`]: https://rsbuild.rs/config/tools/rspack
