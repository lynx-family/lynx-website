...
| --- | --- | --- |
| [`alias`](#source-alias) <span className="api-badge api-badge-deprecated">Deprecated</span> | `Record<string, string \| false \| string[]>` | `Resolve.alias`  - Use [`Resolve.alias`](#resolve-alias) instead. |
| [`assetsInclude`](#source-assetsinclude) | `RuleSetCondition` | Include additional files that should be treated as static assets. |
| [`decorators`](#source-decorators) | `Decorators` | Used to configure the decorators syntax. |
| [`define`](#source-define) | `DefinePluginOptions` | The `define` options is used to define some values or expressions at compile time. |
| [`entry`](#source-entry) | `Entry` | The [`Entry`](#entry) option is used to set the entry module. |
...
| [`transformImport`](#source-transformimport) | `TransformImport[]` | The [`TransformImport`](#transformimport) option transforms the import paths to enable modular imports from subpaths of third-party packages, similar to the functionality provided by [babel-plugin-import](https://npmjs.com/package/babel-plugin-import). |
...
`Resolve.alias`
 ...
 - Use [`Resolve.alias`](#resolve-alias) instead.
...
The [`Entry`](#entry) option is used to set the entry module.
...
- Use multiple entries with [`EntryDescription`](#entrydescription):
...
The [`TransformImport`](#transformimport) option transforms the import paths to enable modular imports from subpaths of third-party packages, similar to the functionality provided by [babel-plugin-import](https://npmjs.com/package/babel-plugin-import).
...
- The `paths` field is used to configure [`Path Aliases`](#source-alias).
