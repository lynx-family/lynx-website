...
- [How to use the Lynx Native Extension `<webview>` element](#embed-and-manage-web-content-with-the-webview-element)
...
## How to Use the [Lynx Native Extension](/lynxtron/Native-Extension/Native-UI-Extension) `<webview>` Element {#embed-and-manage-web-content-with-the-webview-element}
