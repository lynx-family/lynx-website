...
<img
  ...
  src="/assets/lynx-ui-docs/threeBouncingStepsLight.png"
  width="100%"
/>
<img
  className="compatibility-img-dark"
  src="/assets/lynx-ui-docs/threeBouncingStepsDark.png"
  width="100%"
/>
...
3. Thresholds (startBounceTriggerDistance/endBounceTriggerDistance) prevent oversensitive triggering:
   <img
     className="compatibility-img-light"
     src="/assets/threeBouncingStepsLight.png"
     width="100%"
   />
   <img
     className="compatibility-img-dark"
     src="/assets/lynx-ui-docs/onScrollToBouncesLight.png"
     width="100%"
   />
