...
import ThreeBouncingStepsDark from '@assets/ScrollView/threeBouncingStepsDark.png';
import ThreeBouncingStepsLight from '@assets/ScrollView/threeBouncingStepsLight.png';
import OnScrollToBouncesLight from '@assets/ScrollView/onScrollToBouncesLight.png';
...
<img
  ...
  src={ThreeBouncingStepsLight}
  width="100%"
/>
<img
  className="compatibility-img-dark"
  src={ThreeBouncingStepsDark}
  width="100%"
/>
...
3. Thresholds (startBounceTriggerDistance/endBounceTriggerDistance) prevent oversensitive triggering:

   <img className="compatibility-img-light" src={ThreeBouncingStepsLight} width={'100%'} />
   <img className="compatibility-img-dark" src={OnScrollToBouncesLight} width={'100%'} />
