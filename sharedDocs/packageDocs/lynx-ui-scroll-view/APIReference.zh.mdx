...
<UIApiTable
  source={[
    ...
    },
    {
      ...
      summary_zh: '需要设置 items 的预计高度和宽度。',
      defaultValue: '',
      isOption: true,
      isSupportIOS: true,
      isSupportAndroid: true,
    ...
    },
    {
      ...
      summary_zh: '用于全局曝光的 exposure-id',
      defaultValue: '',
      isOption: true,
      isSupportIOS: true,
      isSupportAndroid: true,
    ...
    },
    {
      ...
      summary_zh: '用于全局曝光的 exposure-scene',
      defaultValue: '',
      isOption: true,
      isSupportIOS: true,
      isSupportAndroid: true,
    ...
    },
    {
      ...
      summary_zh: '如果想使用 gesture API，请传入该属性。',
      defaultValue: '',
      isOption: true,
      isSupportIOS: true,
      isSupportAndroid: true,
    ...
    },
    {
      ...
      summary_zh: '用于标记懒加载的曝光时机。请确保页面中唯一。',
      defaultValue: '',
      isOption: true,
      isSupportIOS: true,
      isSupportAndroid: true,
  ...
  source={[
    {
      ...
      summary_zh: '与 onLongPress 相同，但会阻止事件冒泡。',
      defaultValue: '',
      isOption: true,
      isSupportIOS: true,
      isSupportAndroid: true,
    ...
    },
    {
      ...
      summary_zh: '与 onTouchCancel 相同，但会阻止事件冒泡。',
      defaultValue: '',
      isOption: true,
      isSupportIOS: true,
      isSupportAndroid: true,
    ...
    },
    {
      ...
      summary_zh: '与 onTouchEnd 相同，但会阻止事件冒泡。',
      defaultValue: '',
      isOption: true,
      isSupportIOS: true,
      isSupportAndroid: true,
    ...
    },
    {
      ...
      summary_zh: '与 onTouchMove 相同，但会阻止事件冒泡。',
      defaultValue: '',
      isOption: true,
      isSupportIOS: true,
      isSupportAndroid: true,
    ...
    },
    {
      ...
      summary_zh: '与 onTouchStart 相同，但会阻止事件冒泡。',
      defaultValue: '',
      isOption: true,
      isSupportIOS: true,
      isSupportAndroid: true,
    ...
    },
    {
      ...
      summary_zh: '当触摸点在 UI 上按住一段时间后发送。',
      defaultValue: '',
      isOption: true,
      isSupportIOS: true,
      isSupportAndroid: true,
    ...
    {
      name: 'onScrollEnd',
      type: '(e: [object Object] | undefined) => void',
      summary: [
        {
          kind: 'text',
