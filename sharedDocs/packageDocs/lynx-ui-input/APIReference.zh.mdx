...
<UIApiTable
  source={[
    ...
    },
    {
      ...
      summary_zh: '输入框键盘感知组件的额外偏移量, 单位是 px',
      defaultValue: '0',
      isOption: true,
      isSupportIOS: true,
      isSupportAndroid: true,
