...
import testData from '../lynx-compat-data/test/api.json';
import platformsData from '../lynx-compat-data/platforms/platforms.json';
...
Additionally, we downloaded some icons to represent Lynx platforms e.g. `icon-android`, `icon-ios`, `icon-clay`, `icon-web`, etc.
