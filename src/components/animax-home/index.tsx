...
import { Head, useLang, withBase } from '@rspress/core/runtime';
    ...
    features: [
      {
        ...
        body: (
          <>
            ...
            <a href={withBase('/animax/afx.html')}>AFX</a> plugin exports assets
            with instant result previews, helping designers catch issues earlier
            without rebuilding their motion workflow.
          </>
        ),
        wide: true,
      },
    ...
    features: [
      {
        ...
        body: (
          <>
            ...
            Effects <a href={withBase('/zh/animax/afx.html')}>AFX</a>{' '}
...
export default function AnimaxHome() {
  ...
  useEffect(() => {
    const updateNavScrollState = () => {
      document.body.classList.toggle('notTopArrived', window.scrollY > 0);
    };
  ...
  return (
    <>
      <Head>
        <htmlAttrs data-animax-home="true" />
      </Head>
